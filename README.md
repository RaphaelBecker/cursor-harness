...
**hooks**, and **automation stubs**. Day/night lifecycle (plan contract → autonomous
execution) without binding to one product stack.
...
This harness utilized the dayshift - nifhtshift approach, sepapration when possobile,   
optimizing overall workforce efficienzy and using human interaction only when needed.   
  
This harness is also insprired by skills and modern approaches to AI Enginnering by mattpocock.

Install as a git submodule, then `install.sh` into `.cursor/`. Product policy stays in
...
```mermaid
%%{init: {"theme":"base","themeVariables":{"fontFamily":"ui-sans-serif,system-ui,sans-serif","fontSize":"15px","lineColor":"#64748b"},"flowchart":{"curve":"linear","htmlLabels":true,"nodeSpacing":26,"rankSpacing":36,"padding":10,"useMaxWidth":true}}}%%
flowchart LR
  b1["<b><u>Pull Ready</u></b><br/>✦ batch-issue-ingest"]
  b2["<b><u>Tag bug or feature</u></b><br/>✦ batch-issue-ingest"]
  b3["<b><u>Value and UX</u></b><br/>features only<br/>✦ market-ux-strategy<br/>✦ value-validator"]
  b4{"<b><u>Keep, cut, drop?</u></b><br/>◉ HIL"}
  b5["<b><u>Rewrite texts</u></b><br/>✦ issue-text-refiner"]
  b6{"<b><u>Texts OK?</u></b><br/>◉ HIL"}
  b7["<b><u>Write to GitHub</u></b><br/>✦ issue-board-sync"]
  b1 --> b2 --> b3 --> b4 --> b5 --> b6 --> b7
  classDef skill fill:#eef2ff,stroke:#4338ca,stroke-width:1.5px,color:#1e1b4b
  classDef hil fill:#fff7ed,stroke:#c2410c,stroke-width:2px,color:#7c2d12
  classDef done fill:#ecfdf5,stroke:#047857,stroke-width:1.5px,color:#064e3b
...
%%{init: {"theme":"base","themeVariables":{"fontFamily":"ui-sans-serif,system-ui,sans-serif","fontSize":"15px","lineColor":"#64748b"},"flowchart":{"curve":"linear","htmlLabels":true,"nodeSpacing":26,"rankSpacing":36,"padding":10,"useMaxWidth":true}}}%%
flowchart LR
  d1["<b><u>Load context</u></b><br/>✦ project-memory<br/>▣ doc-routing"]
  d2["<b><u>Grill</u></b><br/>✦ grill-me"]
  d3["<b><u>Draft plan</u></b><br/>✦ grill-me"]
  d4{"<b><u>Plan OK?</u></b><br/>◉ HIL<br/>✦ implementation-plan-review"}
  n1["<b><u>Tests, then code</u></b><br/>✦ execute-approved-plan<br/>✦ generate-bdd-test-spec<br/>◇ verifier"]
  n2["<b><u>Test ladder</u></b><br/>▣ testing<br/>targeted → fast → full<br/>◇ verifier"]
  n3["<b><u>Keep tree clean</u></b><br/>✦ review-code<br/>✦ sync-spec-docs<br/>✦ project-memory<br/>◇ Bugbot<br/>◇ Security Review"]
  n4["<b><u>Handoff</u></b><br/>merge-ready · no push"]
...
```mermaid
%%{init: {"theme":"base","themeVariables":{"fontFamily":"ui-sans-serif,system-ui,sans-serif","fontSize":"15px","lineColor":"#64748b"},"flowchart":{"curve":"linear","htmlLabels":true,"nodeSpacing":32,"rankSpacing":44,"padding":10,"useMaxWidth":true}}}%%
flowchart LR
  s1["<b><u>Merge to local main</u></b><br/>◉ HIL<br/>✦ ship-local"]
  s2["<b><u>Push, CI, prod</u></b><br/>◉ HIL<br/>✦ ship-prod<br/>◇ ci-investigator<br/>◇ Bugbot"]
  s3["<b><u>Remember</u></b><br/>✦ project-memory"]
  s1 --> s2 --> s3
  classDef hil fill:#fff7ed,stroke:#c2410c,stroke-width:2px,color:#7c2d12
  classDef done fill:#ecfdf5,stroke:#047857,stroke-width:1.5px,color:#064e3b
  class s1,s2 hil
...
**✦ skill** playbook  ·  **◉ HIL** you decide  ·  **▣ rule** always-on  ·  **◇ subagent** helper
...
```mermaid
%%{init: {"theme":"base","themeVariables":{"fontFamily":"ui-sans-serif,system-ui,sans-serif","fontSize":"12px","lineColor":"#94a3b8"},"flowchart":{"curve":"basis","htmlLabels":true,"nodeSpacing":22,"rankSpacing":40}}}%%
flowchart LR
  A["<b><u>Pull Ready issues</u></b><br/>✦ batch-issue-ingest"]
  B{"<b><u>Bug or feature?</u></b><br/>✦ batch-issue-ingest"}
  C["<b><u>Value and simplest UX</u></b><br/>✦ market-ux-strategy<br/>✦ value-validator"]
  D{"<b><u>Keep, cut, or drop?</u></b><br/>◉ HIL"}
  E["<b><u>Rewrite the issue</u></b><br/>✦ issue-text-refiner"]
  F{"<b><u>Texts look right?</u></b><br/>◉ HIL"}
  G["<b><u>Write to GitHub</u></b><br/>✦ issue-board-sync"]
  X["<b><u>Leave the board</u></b>"]
  ...
  classDef hil fill:#fff7ed,stroke:#c2410c,stroke-width:2px,color:#7c2d12
  classDef done fill:#ecfdf5,stroke:#047857,stroke-width:1.5px,color:#064e3b
  classDef drop fill:#fff1f2,stroke:#e11d48,color:#881337
  class A,B,C,E skill
  class D,F hil
  class G done
  class X drop
...
%%{init: {"theme":"base","themeVariables":{"fontFamily":"ui-sans-serif,system-ui,sans-serif","fontSize":"12px","lineColor":"#94a3b8"},"flowchart":{"curve":"basis","htmlLabels":true,"nodeSpacing":22,"rankSpacing":40}}}%%
flowchart LR
  A(["<b><u>Start</u></b><br/>◉ HIL<br/>✦ feature-delivery"])
  B["<b><u>Hard questions</u></b><br/>✦ project-memory<br/>✦ grill-me<br/>◇ explore"]
  C["<b><u>Write the plan</u></b><br/>✦ grill-me"]
  D{"<b><u>Plan look right?</u></b><br/>◉ HIL<br/>✦ implementation-plan-review"}
  E["<b><u>Tests, then the feature</u></b><br/>✦ execute-approved-plan<br/>✦ generate-bdd-test-spec<br/>◇ verifier"]
  F["<b><u>Check, review, docs</u></b><br/>✦ review-code<br/>✦ sync-spec-docs<br/>✦ project-memory<br/>◇ Bugbot<br/>◇ Security Review"]
  G["<b><u>Merge local</u></b><br/>◉ HIL<br/>✦ ship-local"]
  H["<b><u>Ship prod</u></b><br/>◉ HIL<br/>✦ ship-prod<br/>◇ ci-investigator<br/>◇ Bugbot"]
...
%%{init: {"theme":"base","themeVariables":{"fontFamily":"ui-sans-serif,system-ui,sans-serif","fontSize":"12px","lineColor":"#94a3b8"},"flowchart":{"curve":"basis","htmlLabels":true,"nodeSpacing":22,"rankSpacing":40}}}%%
flowchart LR
  A(["<b><u>Describe the bug</u></b><br/>◉ HIL<br/>✦ bugfix"])
  B{"<b><u>Big or risky?</u></b><br/>✦ bugfix"}
  C["<b><u>Questions and plan</u></b><br/>✦ grill-me<br/>◇ explore"]
  D{"<b><u>Plan look right?</u></b><br/>◉ HIL<br/>✦ implementation-plan-review"}
  T{"<b><u>Skip the long plan?</u></b><br/>◉ HIL"}
  E["<b><u>Failing test first</u></b><br/>✦ execute-approved-plan<br/>◇ verifier"]
  F["<b><u>Smallest fix</u></b><br/>✦ execute-approved-plan<br/>◇ verifier"]
  G["<b><u>Check, review, docs</u></b><br/>✦ review-code<br/>✦ sync-spec-docs<br/>✦ project-memory<br/>◇ Bugbot<br/>◇ Security Review"]
  H["<b><u>Ship</u></b><br/>◉ HIL<br/>✦ ship-local<br/>✦ ship-prod<br/>◇ ci-investigator"]
...
%%{init: {"theme":"base","themeVariables":{"fontFamily":"ui-sans-serif,system-ui,sans-serif","fontSize":"12px","lineColor":"#94a3b8"},"flowchart":{"curve":"basis","htmlLabels":true,"nodeSpacing":22,"rankSpacing":40}}}%%
flowchart LR
  A(["<b><u>Work is done locally</u></b>"])
  B["<b><u>Merge local</u></b><br/>◉ HIL<br/>✦ ship-local"]
  C["<b><u>Push and watch CI</u></b><br/>◉ HIL<br/>✦ ship-prod<br/>◇ ci-investigator"]
  D{"<b><u>CI red?</u></b>"}
  E["<b><u>Fix, then watch again</u></b><br/>✦ bugfix<br/>✦ review-code<br/>◇ Bugbot<br/>◇ verifier"]
  F(["<b><u>Green — remember</u></b><br/>✦ project-memory"])
  ...
  classDef skill fill:#eef2ff,stroke:#4338ca,stroke-width:1.5px,color:#1e1b4b
  classDef hil fill:#fff7ed,stroke:#c2410c,stroke-width:2px,color:#7c2d12
  classDef you fill:#f8fafc,stroke:#64748b,color:#0f172a
  classDef done fill:#ecfdf5,stroke:#047857,stroke-width:1.5px,color:#064e3b
  class A you
  class B,C hil
  class D you
...
%%{init: {"theme":"base","themeVariables":{"fontFamily":"ui-sans-serif,system-ui,sans-serif","fontSize":"12px","lineColor":"#94a3b8"},"flowchart":{"curve":"basis","htmlLabels":true,"nodeSpacing":22,"rankSpacing":40}}}%%
flowchart LR
  A(["<b><u>Tests hurt</u></b><br/>◉ HIL"])
  B["<b><u>Find flakes and slowness</u></b><br/>✦ test-harness-optimize<br/>◇ verifier"]
  C["<b><u>Harden, keep asserts</u></b><br/>✦ test-harness-optimize<br/>◇ verifier"]
  D(["<b><u>Green and honest</u></b>"])
...
%%{init: {"theme":"base","themeVariables":{"fontFamily":"ui-sans-serif,system-ui,sans-serif","fontSize":"12px","lineColor":"#94a3b8"},"flowchart":{"curve":"basis","htmlLabels":true,"nodeSpacing":22,"rankSpacing":40}}}%%
flowchart LR
  A(["<b><u>Create the job</u></b><br/>◉ HIL"])
  B["<b><u>Clock or CI fires</u></b>"]
  C["<b><u>Cloud agent runs</u></b><br/>✦ test-harness-optimize<br/>◇ verifier"]
  D{"<b><u>Safe to patch?</u></b>"}
  E["<b><u>Draft PR</u></b>"]
  F["<b><u>Report only</u></b>"]
...
%%{init: {"theme":"base","themeVariables":{"fontFamily":"ui-sans-serif,system-ui,sans-serif","fontSize":"12px","lineColor":"#94a3b8"},"flowchart":{"curve":"basis","htmlLabels":true,"nodeSpacing":22,"rankSpacing":40}}}%%
flowchart LR
  a1["<b><u>Load context</u></b><br/>✦ project-memory<br/>▣ doc-routing"]
  a2["<b><u>Map smells</u></b><br/>✦ architecture-audit (new)<br/>◇ explore"]
  a3{"<b><u>Which slice?</u></b><br/>◉ HIL"}
  a4["<b><u>Grill and plan</u></b><br/>✦ grill-me"]
  a5{"<b><u>Plan OK?</u></b><br/>◉ HIL<br/>✦ implementation-plan-review"}
  a6["<b><u>One refactor</u></b><br/>✦ extract-deep-module (new)<br/>or ✦ dependency-direction-fix (new)"]
  a7["<b><u>Prove</u></b><br/>▣ testing<br/>◇ verifier"]
  a8["<b><u>Review</u></b><br/>✦ review-code<br/>✦ sync-spec-docs<br/>◇ Bugbot<br/>◇ Security Review"]
  a9["<b><u>Remember</u></b><br/>✦ project-memory"]

  a1 --> a2 --> a3 --> a4 --> a5 --> a6 --> a7 --> a8 --> a9

  classDef skill fill:#eef2ff,stroke:#4338ca,stroke-width:1.5px,color:#1e1b4b
  classDef proposed fill:#fefce8,stroke:#ca8a04,stroke-width:1.5px,color:#713f12
  classDef hil fill:#fff7ed,stroke:#c2410c,stroke-width:2px,color:#7c2d12
  classDef done fill:#ecfdf5,stroke:#047857,stroke-width:1.5px,color:#064e3b
...
%%{init: {"theme":"base","themeVariables":{"fontFamily":"ui-sans-serif,system-ui,sans-serif","fontSize":"12px","lineColor":"#94a3b8"},"flowchart":{"curve":"basis","htmlLabels":true,"nodeSpacing":22,"rankSpacing":40}}}%%
flowchart LR
  u1["<b><u>Green snapshot</u></b><br/>✦ green-run-hygiene (new)<br/>◇ verifier"]
  u2["<b><u>Split the report</u></b><br/>one skill each · parallel OK<br/>✦ lint-debt-fix (new)<br/>✦ test-security-findings (new)<br/>✦ flake-hunter (new)<br/>✦ coverage-gap-fill (new)<br/>✦ e2e-merge-redundant (new)<br/>◇ Security Review"]
  u3{"<b><u>Which tracks?</u></b><br/>◉ HIL"}
  u4["<b><u>Apply one job</u></b><br/>only the skills you approved"]
  u5["<b><u>Prove</u></b><br/>▣ testing<br/>asserts stay strict<br/>◇ verifier"]
  u6["<b><u>Remember</u></b><br/>✦ project-memory"]
...
%%{init: {"theme":"base","themeVariables":{"fontFamily":"ui-sans-serif,system-ui,sans-serif","fontSize":"12px","lineColor":"#94a3b8"},"flowchart":{"curve":"basis","htmlLabels":true,"nodeSpacing":22,"rankSpacing":40}}}%%
flowchart LR
  f1["<b><u>Load tokens</u></b><br/>✦ project-memory<br/>▣ consumer design-tokens"]
  f2["<b><u>Map outliers</u></b><br/>✦ design-token-audit (new)<br/>◇ explore"]
  f3{"<b><u>Tokens complete?</u></b><br/>◉ HIL"}
  f4["<b><u>Centralize CSS</u></b><br/>✦ design-token-ssot (new)<br/>light + dark"]
  f5{"<b><u>Which family?</u></b><br/>◉ HIL<br/>buttons · charts · one screen"}
  f6["<b><u>Align one family</u></b><br/>✦ ui-outlier-align (new)<br/>or ✦ chart-theme-align (new)"]
  f7["<b><u>Prove</u></b><br/>▣ testing<br/>◇ verifier"]
  f8["<b><u>Remember</u></b><br/>✦ project-memory"]
...
%%{init: {"theme":"base","themeVariables":{"fontFamily":"ui-sans-serif,system-ui,sans-serif","fontSize":"12px","lineColor":"#94a3b8"},"flowchart":{"curve":"basis","htmlLabels":true,"nodeSpacing":22,"rankSpacing":40}}}%%
flowchart LR
  d1["<b><u>Inventory docs</u></b><br/>✦ doc-inventory (new)<br/>◇ explore"]
  d2["<b><u>Coverage gate</u></b><br/>✦ docs-coverage-gate (new)<br/>◇ verifier"]
  d3{"<b><u>Which slice?</u></b><br/>◉ HIL<br/>size follows coverage"}
  d4["<b><u>Fill test holes</u></b><br/>✦ generate-bdd-test-spec<br/>✦ coverage-gap-fill (new)"]
  d5["<b><u>Rewrite as stories</u></b><br/>✦ story-migrate-slice (new)"]
  d6["<b><u>Retire tech dupes</u></b><br/>✦ tech-doc-retire (new)<br/>only if tests cover it"]
  d7["<b><u>Remember</u></b><br/>✦ project-memory<br/>✦ review-docs"]
...
%%{init: {"theme":"base","themeVariables":{"fontFamily":"ui-sans-serif,system-ui,sans-serif","fontSize":"12px","lineColor":"#94a3b8"},"flowchart":{"curve":"basis","htmlLabels":true,"nodeSpacing":22,"rankSpacing":40}}}%%
flowchart LR
  p1["<b><u>Load context</u></b><br/>✦ project-memory<br/>▣ doc-routing"]
  p2["<b><u>Profile</u></b><br/>✦ perf-profile (new)<br/>◇ explore"]
  p3["<b><u>Split the report</u></b><br/>one skill each<br/>✦ slow-query-find (new)<br/>✦ slow-path-find (new)"]
  p4{"<b><u>Which hotspot?</u></b><br/>◉ HIL"}
  p5["<b><u>One fix</u></b><br/>✦ perf-fix-query (new)<br/>or ✦ perf-fix-hotpath (new)"]
  p6["<b><u>Prove faster</u></b><br/>same profiler + ▣ testing<br/>◇ verifier"]
  p7["<b><u>Remember</u></b><br/>✦ project-memory"]
