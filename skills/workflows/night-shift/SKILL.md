...
equals the number of ready trees. If `slots` is set, wait for a lease — do not
skip tests. About **3** parallel agents has been comfortable on a laptop; that is
experience, not a harness cap.
